...
public class ProblemPositionActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.activity_problem_position;
    }
    ...
    public void initViews() {
        ...
        etText.setText(TextUtils.isEmpty(tsPosition) ? "" : tsPosition);
