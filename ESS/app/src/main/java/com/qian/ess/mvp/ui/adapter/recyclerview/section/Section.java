...
public abstract class Section {
     ...
     */
    public BaseViewHolder getHeaderViewHolder(Context context, View view) {
     ...
     */
    public void onBindHeaderViewHolder(BaseViewHolder holder) {
     ...
     */
    public BaseViewHolder getFooterViewHolder(Context context, View view) {
        return new SectionRVAdapter.EmptyViewHolder(context, view);
    }
     ...
     */
    public void onBindFooterViewHolder(BaseViewHolder holder) {
        // Nothing to bind here.
    }
     ...
     */
    public BaseViewHolder getLoadingViewHolder(Context context, View view) {
        return new SectionRVAdapter.EmptyViewHolder(context, view);
    }
     ...
     */
    public BaseViewHolder getFailedViewHolder(Context context, View view) {
        return new SectionRVAdapter.EmptyViewHolder(context, view);
    }
