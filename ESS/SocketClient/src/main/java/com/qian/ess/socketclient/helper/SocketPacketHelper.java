package com.qian.ess.socketclient.helper;
...
public class SocketPacketHelper {
    ...
    public enum ReadStrategy {
        /**
         * 手动读取
         * 手动调用{@link com.qian.ess.socketclient.SocketClient#readDataToData(byte[])}或{@link com.qian.ess.socketclient.SocketClient#readDataToLength(int)}读取
         */
        Manually,
        /**
         * 自动读取到包尾
