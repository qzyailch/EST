package com.qian.ess.oksocket.sdk.connection.interfacies;
...
public interface ISocketActionListener {
     ...
     *
     * @param context 上下文
     * @param action  {@link com.qian.ess.oksocket.sdk.connection.interfacies.IAction#ACTION_READ_THREAD_START}
     *                {@link  com.qian.ess.oksocket.sdk.connection.interfacies.IAction#ACTION_WRITE_THREAD_START}
     */
     ...
     *
     * @param context 上下文
     * @param action  {@link com.qian.ess.oksocket.sdk.connection.interfacies.IAction#ACTION_READ_THREAD_SHUTDOWN}
     *                {@link  com.qian.ess.oksocket.sdk.connection.interfacies.IAction#ACTION_WRITE_THREAD_SHUTDOWN}
     ...
     *
     * @param context 上下文
     * @param action  {@link com.qian.ess.oksocket.sdk.connection.interfacies.IAction#ACTION_READ_COMPLETE}
     ...
     *
     * @param context 上下文
     * @param action  {@link com.qian.ess.oksocket.sdk.connection.interfacies.IAction#ACTION_WRITE_COMPLETE}
     ...
     * @param context 上下文
     * @param info    这次连接的连接信息
     * @param action  {@link com.qian.ess.oksocket.sdk.connection.interfacies.IAction#ACTION_DISCONNECTION}
     ...
     * @param context 上下文
     * @param info    这次连接的连接信息
     * @param action  {@link com.qian.ess.oksocket.sdk.connection.interfacies.IAction#ACTION_CONNECTION_SUCCESS}
     */
     ...
     * @param context 上下文
     * @param info    这次连接的连接信息
     * @param action  {@link com.qian.ess.oksocket.sdk.connection.interfacies.IAction#ACTION_CONNECTION_FAILED}
