...
import com.qian.ess.camera.listener.CaptureListener;
import com.qian.ess.camera.listener.ClickListener;
import com.qian.ess.camera.listener.ReturnListener;
import com.qian.ess.camera.listener.TypeListener;


/**
 * =====================================
 * 作    者: 钱真勇 1563354365@qq.com
 * 版    本：1.0.4
 * 创建日期：2017/4/26
 * 描    述：集成各个控件的布局
 * =====================================
...
public class CaptureLayout extends FrameLayout {
    ...
    private ImageView btn_center;         //中间按钮
    ...
    private void initView() {
        ...
        btn_cancel_param.setMargins((layout_width - button_size * 3) / 4, 0, 0, 0);
...
//                resetCaptureLayout();
        ...
        btn_confirm_param.setMargins(0, 0, (layout_width - button_size * 3) / 4, 0);
...
//                resetCaptureLayout();
        ...
        //确认按钮
        btn_center = new ImageView(getContext());
        btn_center.setImageResource(R.drawable.icon_study);
        LayoutParams iv_custom_param_btn_center = new LayoutParams(button_size, button_size);
        iv_custom_param_btn_center.gravity = Gravity.CENTER_VERTICAL | Gravity.CENTER;
        iv_custom_param_btn_center.setMargins(0, 0, 0, 0);
        btn_center.setLayoutParams(iv_custom_param_btn_center);
